      ...
      <el-aside width="160px">
        ...
        <el-menu :default-openeds="['1', '3']">
          <el-menu-item index="1">
            ...
            <router-link to="/home/Host" class="redTextWithoutUnderline"
              >主机</router-link
            >
          </el-menu-item>
          <el-menu-item index="2">
            <i class="el-icon-suitcase"></i>
            <router-link to="/home/Kit" class="redTextWithoutUnderline"
              >工具
            </router-link>
          </el-menu-item>
          <el-menu-item index="3">
            <i class="el-icon-setting"></i>
            <router-link to="/home/Set" class="redTextWithoutUnderline"
              >设置</router-link
            >
          </el-menu-item>
        </el-menu>
